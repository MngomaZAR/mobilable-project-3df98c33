...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 26, fontWeight: '800', color: '#07111f', marginTop: 14, textAlign: 'center' },
  subtitle: { fontSize: 14, color: '#526079', textAlign: 'center', marginTop: 8, lineHeight: 20 },
  switcher: {
    flexDirection: 'row',
  ...
  switchTxt: { color: '#5f6f89', fontWeight: '600', fontSize: 14 },
  switchTxtActive: { color: '#07111f', fontWeight: '800' },
  // Role picker
  ...
  roleTitle: { fontSize: 13, fontWeight: '700', color: '#07111f', textAlign: 'center', marginBottom: 4 },
  roleDesc: { fontSize: 10, color: '#7687a0', textAlign: 'center', lineHeight: 14 },
  ...
  input: { flex: 1, fontSize: 15, color: '#07111f', height: '100%' },
  eyeBtn: { padding: 6 },
  ...
  dividerLine: { flex: 1, height: 1, backgroundColor: 'rgba(148,163,184,0.22)' },
  dividerTxt: { marginHorizontal: 14, color: '#73839b', fontWeight: '500', fontSize: 13 },
  ...
  oauthTxt: { color: '#07111f', fontWeight: '700', fontSize: 14 },
