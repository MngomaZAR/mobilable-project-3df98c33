...
const styles = StyleSheet.create({
  ...
  methodActions: { flexDirection: 'row', alignItems: 'center', gap: 8, marginTop: 6, flexWrap: 'wrap' },
  smallBtn: { borderWidth: 1, borderRadius: 12, paddingVertical: 7, paddingHorizontal: 10, overflow: 'hidden' },
